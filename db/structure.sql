...
DROP INDEX IF EXISTS public.index_users_on_qm_uuid;
DROP INDEX IF EXISTS public.index_users_on_name;
...
CREATE TABLE public.users (
    ...
    qm_uuid uuid DEFAULT gen_random_uuid() NOT NULL,
    created_at timestamp(6) without time zone NOT NULL,
    updated_at timestamp(6) without time zone NOT NULL
);
...
--
-- Name: index_users_on_qm_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_users_on_qm_uuid ON public.users USING btree (qm_uuid);
